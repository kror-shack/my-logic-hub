...
// ) => {
//   const useDerivativeRules = false;
...
//     }
//     if (operator === "&") {
//       const values = simplifyAndOperation(premise, knowledgeBase); //no derivated theorums used
...
//     } else if (operator === "|") {
//       const values = checkDisjunctionSolvability(
//         premise,
//         knowledgeBase,
//         useDerivativeRules
//       ); //TODO: for the ui convert D.S to M.T.P
//       knowledgeBase = values.knowledgeBase;
//       const convertedDeductionSteps = convertToModernLogicDeductions(
//         values.deductionStepsArr
//       );
//       deductionStepsArr.push(...convertedDeductionSteps);
//     } else if (operator === "->") {
//       const values = checkImplicationSolvability(
//         premise,
//         knowledgeBase,
//         useDerivativeRules
//       );
...
//       deductionStepsArr.push(...convertedDeductionSteps);
//     } else if (operator === "<->") {
//       const values = simplifyBiConditional(premise, knowledgeBase); // no derivative thoerums used
//       knowledgeBase = values.knowledgeBase;
//       const convertedDeductionSteps = convertToModernLogicDeductions(
//         values.deductionStepsArr
//       );
